...
public class AddTripActivity extends AppCompatActivity implements OnDateSelectedListener {
    private EditText tripName, destination;
    private RadioGroup radioGroup;
    private RadioButton tripType;
    private Slider price;
    private RatingBar rating;
    private Button addButton, startDateButton, endDateButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.addButton = findViewById(R.id.button_addTrip);
        ...
        this.addButton.setOnClickListener(this::addNewTrip);
